# DATA-06 — historical handoff import

Sprint: DATA-06 — Provider-derived reproducible snapshot
...
- DATA-06-AC1: Wire garbage atau event berbeda dari parse ditolak
- DATA-06-AC2: Cap observation direkonstruksi dari body provider
- DATA-06-AC3: Dua root berbeda memberi snapshot dan global decision ID identik
...
Offline fixtures prove contracts, not live provider health, real historical completeness, or host capacity. Original environment paths in evidence may no longer exist. Reverify affected contract after any implementation change. Next: FEAT-01, SIM-03, LOB-01, OPS-02.
