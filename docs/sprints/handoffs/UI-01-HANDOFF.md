...
- Mobile quick navigation follows the active context with 48px minimum targets. Existing graphite/Kumo/Geist styling and DESIGN.md tokens remain in place.

## Verification

- `npm test` (from `frontend/`) — PASS, 3 files / 10 tests.
