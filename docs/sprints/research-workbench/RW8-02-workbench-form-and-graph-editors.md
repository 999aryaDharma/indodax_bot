...
- [ ] **RW8-02-AC5** Form and YAML edits use one revisioned draft validator and preserve semantic identity. Evidence: `test_rw8_02_program_5` at exact implementation SHA.
