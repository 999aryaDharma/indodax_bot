...
| API-02 | Read-only Production API application and routes | production-main | P0 | integration | API-01, API-03 | READY | [Spec](production-main\API-02-read-only-production-api-application-and-routes.md) |
...
| UI-01 | Production and Research context navigation with capability boundary | production-main | P1 | integration | UI-00, API-03 | READY | [Spec](production-main\UI-01-production-and-research-context-navigation-with-capability-boundary.md) |
