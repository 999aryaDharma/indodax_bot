...
| FEAT-01 | Versioned feature registry | features | P0 | data | DATA-06 | REVIEW | [Spec](features\FEAT-01-versioned-feature-registry.md) |
| FEAT-02 | Golden technical and liquidity transforms | features | P0 | data | FEAT-01 | REVIEW | [Spec](features\FEAT-02-golden-technical-and-liquidity-transforms.md) |
...
| DOC-01 | Frozen architecture audit and delivery program | planning | P0 | planning | — | REVIEW | [Spec](planning\DOC-01-frozen-architecture-audit-and-delivery-program.md) |
| RP-01 | Shared SignalIntent ownership with compatibility | runtime-parity | P0 | integration | DOC-01, BASE-01 | BLOCKED | [Spec](runtime-parity\RP-01-shared-signalintent-ownership-with-compatibility.md) |
...
| PM-01 | Authoritative fail-closed pre-write gate | production-main | P0 | integration | RW0-01 | PLANNED | [Spec](production-main\PM-01-authoritative-fail-closed-pre-write-gate.md) |
