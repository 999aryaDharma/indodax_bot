...
| RW6-01 | Separate shared-capital Portfolio Shadow | research-workbench | P1 | integration | RW5-01, RP-03 | PLANNED | [Spec](research-workbench\RW6-01-separate-shared-capital-portfolio-shadow.md) |
| RW7-01 | Read-only QuantOps MCP boundary | research-workbench | P1 | integration | RW1-01, RW2-03, RW4-01 | PLANNED | [Spec](research-workbench\RW7-01-read-only-quantops-mcp-boundary.md) |
...
| PM-06 | CI security and operational release evidence | production-main | P0 | integration | PM-05, RW5-01 | PLANNED | [Spec](production-main\PM-06-ci-security-and-operational-release-evidence.md) |
...
| API-00 | Shared API envelope, error, provenance and capability contracts | production-main | P0 | integration | — | IN_PROGRESS | [Spec](production-main\API-00-shared-api-envelope-error-provenance-and-capability-contracts.md) |
| API-01 | Production service-derived read models | production-main | P0 | integration | API-00, PM-01, PM-02, PM-03, PM-04 | PLANNED | [Spec](production-main\API-01-production-service-derived-read-models.md) |
| API-03 | Fail-closed read capability policy and audit context | production-main | P0 | integration | API-00 | PLANNED | [Spec](production-main\API-03-fail-closed-read-capability-policy-and-audit-context.md) |
| API-02 | Read-only Production API application and routes | production-main | P0 | integration | API-01, API-03 | PLANNED | [Spec](production-main\API-02-read-only-production-api-application-and-routes.md) |
| UI-00 | Kumo and Geist shell foundation with typed API client | production-main | P1 | integration | — | IN_PROGRESS | [Spec](production-main\UI-00-kumo-and-geist-shell-foundation-with-typed-api-client.md) |
| UI-01 | Production and Research context navigation with capability boundary | production-main | P1 | integration | UI-00, API-03 | PLANNED | [Spec](production-main\UI-01-production-and-research-context-navigation-with-capability-boundary.md) |
| UI-02 | Read-only Production operational pages | production-main | P1 | integration | UI-01, API-02 | PLANNED | [Spec](production-main\UI-02-read-only-production-operational-pages.md) |
