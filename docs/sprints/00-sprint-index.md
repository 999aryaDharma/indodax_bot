...
| API-01 | Production service-derived read models | production-main | P0 | integration | API-00, PM-01, PM-02, PM-03, PM-04 | READY | [Spec](production-main\API-01-production-service-derived-read-models.md) |
| API-03 | Fail-closed read capability policy and audit context | production-main | P0 | integration | API-00 | READY | [Spec](production-main\API-03-fail-closed-read-capability-policy-and-audit-context.md) |
