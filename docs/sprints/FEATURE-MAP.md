...
- [API-01 — Production service-derived read models](production-main\API-01-production-service-derived-read-models.md) — CORE; Expose immutable Production read snapshots assembled from authoritative domain services.
