...
8. [Control-plane roadmap crosswalk](CONTROL-PLANE-ROADMAP.md) before claiming any API or dashboard task. It explains which proposed units still require manifest admission.
